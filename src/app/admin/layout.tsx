...
import { Bot, LayoutDashboard, Users, CreditCard, DollarSign, Settings, MessageSquare, Stethoscope, Server } from 'lucide-react';
        ...
        <div className="container mx-auto flex h-14 items-center justify-between px-4">
          <div className="flex items-center space-x-4">
            ...
            <nav className="hidden md:flex items-center space-x-1">
              ...
              <Link href="/admin/system" className="px-3 py-2 text-sm text-muted-foreground hover:text-foreground rounded-md hover:bg-muted">
                <Server className="h-4 w-4 inline mr-1" /> System
              </Link>
