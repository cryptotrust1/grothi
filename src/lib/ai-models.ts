...
export const VIDEO_MODELS: AIModel[] = [
  // ── MiniMax Hailuo video-01 (text-to-video) ──
  {
    ...
    name: 'MiniMax Hailuo',
    description: 'High quality text-to-video. Good motion, diverse styles. 5 second clips.',
    category: 'video',
    creditCost: 8,
    supportsReferenceImage: false,
    supportsNegativePrompt: false,
  ...
  // ── MiniMax Hailuo video-01-live (image-to-video) ──
  {
    ...
    description: 'Image-to-video animation. Bring your images to life with motion. Requires reference image.',
    category: 'video',
    creditCost: 8,
    supportsReferenceImage: true,
  ...
  // ── Luma Ray 2 ──
  {
    ...
    name: 'Luma Ray 2',
    description: 'Cinematic quality video generation. Photorealistic output with smooth camera motion.',
    category: 'video',
    creditCost: 10,
    supportsReferenceImage: true,
    referenceImageKey: 'image',
    ...
    params: [
      ...
      },
      {
        ...
        label: 'Loop',
        type: 'boolean',
        description: 'Make the video loop seamlessly.',
        default: false,
        group: 'basic',
      },
      {
  ...
  {
    id: 'kling-v2.1',
    replicateId: 'kling-ai/kling-v2.1-standard',
    name: 'Kling V2.1',
    description: 'High quality AI video with adjustable duration. Supports 5 or 10 second clips.',
    category: 'video',
    creditCost: 10,
    supportsReferenceImage: true,
  ...
  {
    id: 'wan-2.1',
    replicateId: 'wan-ai/wan-2.1-t2v-480p',
    name: 'Wan 2.1',
    description: 'Fast and affordable video generation. Great for quick drafts and social content.',
    category: 'video',
    creditCost: 5,
    supportsReferenceImage: false,
    supportsNegativePrompt: true,
    ...
    params: [
      {
        ...
        type: 'number',
        description: 'Total frames to generate (17-81). More frames = longer video. 24fps.',
        min: 17,
        max: 81,
        step: 4,
        default: 81,
  ...
  // ── Runway (veo3.1_fast via Runway SDK) ──
  {
    id: 'runway-veo3.1',
    replicateId: '', // Not Replicate — uses Runway SDK
    name: 'Runway Veo 3.1',
    description: 'Google Veo 3.1 via Runway. Premium quality with audio generation. Requires Runway API key.',
    category: 'video',
    creditCost: 15,
    supportsReferenceImage: false,
    supportsNegativePrompt: false,
    ...
    params: [
      ...
      },
      {
        ...
        options: [
          { value: '1280:720', label: '1280x720 (16:9 Landscape)' },
          { value: '720:1280', label: '720x1280 (9:16 Vertical)' },
          { value: '1024:1024', label: '1024x1024 (Square)' },
        ],
        default: '1280:720',
        group: 'basic',
      },
